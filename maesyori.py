...
splitted10["階1"] = splitted10["階1"].str.replace("M2", "")
...
df["建物の高さ"] = df["建物の高さ"].str.replace("地下1地上", "")
df["建物の高さ"] = df["建物の高さ"].str.replace("地下2地上", "")
df["建物の高さ"] = df["建物の高さ"].str.replace("地下3地上", "")
df["建物の高さ"] = df["建物の高さ"].str.replace("地下4地上", "")
df["建物の高さ"] = df["建物の高さ"].str.replace("地下5地上", "")
df["建物の高さ"] = df["建物の高さ"].str.replace("地下6地上", "")
df["建物の高さ"] = df["建物の高さ"].str.replace("地下7地上", "")
df["建物の高さ"] = df["建物の高さ"].str.replace("地下8地上", "")
df["建物の高さ"] = df["建物の高さ"].str.replace("地下9地上", "")
df["建物の高さ"] = df["建物の高さ"].str.replace("平屋", "1")
df["建物の高さ"] = df["建物の高さ"].str.replace("階建", "")
...
df["間取り"] = df["間取り"].str.replace("ワンルーム", "1")  # ワンルームを1に変換
...
df["区"] = df["区"].factorize()[0]
df["路線1"] = df["路線1"].factorize()[0]
...
df.to_csv(f"preprocess_{file_name}.csv", sep="\t", encoding="utf-16", index=False)
